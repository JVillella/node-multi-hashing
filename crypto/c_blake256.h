...
void blake256_calc_hash(uint8_t *, const uint8_t *, uint64_t);
void blake224_calc_hash(uint8_t *, const uint8_t *, uint64_t);
...
void hmac_blake256_calc_hash(uint8_t *, const uint8_t *, uint64_t, const uint8_t *, uint64_t);
void hmac_blake224_calc_hash(uint8_t *, const uint8_t *, uint64_t, const uint8_t *, uint64_t);
